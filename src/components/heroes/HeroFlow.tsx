...
/** Variante 5 — Campo de flujo. Partículas fluyendo por un campo de ruido. */
export function HeroFlow() {
  return (
    <section className="relative flex min-h-screen flex-col justify-center overflow-hidden pt-[72px]">
      <div className="pointer-events-none absolute inset-0 lg:left-[28%]" aria-hidden>
        <SceneCanvas name="flow" />
      </div>
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-bg/75 via-transparent to-bg lg:bg-gradient-to-r lg:from-bg lg:via-bg/25 lg:to-transparent"
        aria-hidden
      />
